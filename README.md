...
1) The first step is prepaire the excel file ready as the x and y column's header. So, use the [plot.py](https://github.com/SMNIK/Haynes-Shockley-experiment-M2/blob/master/plot.py) xlsx code reader to plot and calculate the mean and alpha. 
2)  